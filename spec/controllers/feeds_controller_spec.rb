...
RSpec.describe FeedsController, type: :controller do
  ...
  describe 'FeedController GET method' do
    it '404s when feed not found' do
      expect { get :webhook_subscribe, id: 9001 }.to raise_error(ActiveRecord::RecordNotFound)
    end
  ...
  describe 'FeedController POST method' do
    it '404s when feed not found' do
      expect { post :webhook_update, id: 9001 }.to raise_error(ActiveRecord::RecordNotFound)
    end
